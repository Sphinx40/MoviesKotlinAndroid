...
class RecommendationsFragment : Fragment() {
    ...
    private val nowPlayingMoviesAdapter = GroupAdapter<GroupieViewHolder>().apply {
        addAll(Globals.nowPlayingMovies)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        nowPlayingRecyclerView.adapter = nowPlayingMoviesAdapter
        onClickListener(nowPlayingMoviesAdapter)
    }
